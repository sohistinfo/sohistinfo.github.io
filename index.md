...
<details markdown="1">
  ...
  - <a href="https://www.sciencespo.fr/histoire/en/directory/osterlow-anna/" target="blank">Anna Katharina Osterlow<a> est chercheuse doctorante au <a href="https://www.sciencespo.fr/histoire/fr/" target=blank>Centre d’histoire de Sciences Po (CHSP)</a> et au <a href="https://www.sciencespo.fr/ceri/fr/" target="blank">Centre de recherches internationales (CERI)</a>, à <a href="https://www.sciencespo.fr/fr/" target="blank">Science Po</a> Paris. Sa thèse en histoire de l'informatique porte sur deux projets informatiques transnationaux au Nigeria et au Sénégal, des années 1960 à la fin des années 1980. Sa  recherche vise à retracer comment les connaissances et technologies informatiques se sont propagées à travers des échanges transnationaux et des circulations de personnes, d'idées et d'artefacts technologiques. **(Présentation donnée en anglais)**
